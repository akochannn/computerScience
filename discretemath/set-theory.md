...
* 例: $$\{n \mid n \in \mathbb{N} \text{ and n is odd}\}$$
* ちなみに$$\mid$$は$$\LaTeX$$で書く際は`\mid`を使います

つまり

$$
\{x \mid \text{$x$が満たすある条件}\}
$$
...
{% hint style="info" %}
$$A \subset B$$と書くと両者が等しい集合であることを否定するか曖昧なので,ここでは$$\subseteq$$を用いています
{% endhint %}
...
集合$$S = \{n\mid n\in \mathbb{N} \text{ and n is even}\}$$という集合は$$n \leftrightarrow 2n$$と対応付ければ自然数の集合$$\mathbb{N}$$と1組に対応付けられます
