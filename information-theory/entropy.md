...
これはpが小さいほど大きくなります.起きにくいことが起きると知った時の方が確かにおどろくという実態とマッチしているように感じます
...
* 情報を得て状況エントロピーが$$H$$から$$H'$$に変わったときにこの情報量を$$I=H-H'$$とする
...
4. $$
   ...
   これは条件付き確率の定義です.3から用意に求めることができます  
   Bayesの公式とも言われています
...
1. $$
   ...
   $$I(A,B)=H(B)-H_A(B)=H(B)+H(A)-H(A,B)$$であり,  
   $$H(B)-H(A,B)=H_B(A)$$であるということからわかる  
...
5. $$
   ...
   $$AB$$を知ってから$$C$$について得る情報量は,$$A$$を知ってから$$C$$について得る情報量$$A$$を知った後で$$B$$を知ってから$$C$$について得る情報量と等しいということです
